...
public class IgniteRelationalCommandBuilder(RelationalCommandBuilderDependencies dependencies) : IRelationalCommandBuilder
{
    ...
    protected virtual RelationalCommandBuilderDependencies Dependencies { get; } = dependencies;
