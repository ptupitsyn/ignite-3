...
namespace Apache.Ignite.Tx
{
    ...
    public sealed class TransactionException : IgniteException
    {
        /// <summary>
        ...
        private TransactionException(SerializationInfo serializationInfo, StreamingContext streamingContext)
