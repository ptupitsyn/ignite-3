...
public interface TaskExecution<R> {
    ...
    /**
     * Returns the current state of the task. The task state may be deleted and thus return {@code null} if the time for
     * retaining task state has been exceeded.
     *
    ...
    /**
     * Returns the id of the task. The job state may be deleted and thus return {@code null} if the time for retaining job state has been
     * exceeded.
     *
    ...
    /**
     * Returns a collection of states of the tasks which are executing under this task. The resulting future is completed only after the
